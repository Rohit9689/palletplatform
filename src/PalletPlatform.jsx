...
function useSEO() {
  useEffect(() => {
    document.title = "PalletPlatform | Premium Wooden Pallet Manufacturer — Hyderabad, India";
    const metas = [
      { name:"description", content:"PalletPlatform manufactures ISPM-15 certified wooden pallets in Hyderabad. Standard, Euro/EPAL, Export & Custom pallets. Pan-India delivery. 48-hour dispatch. Request a free quote today." },
      ...
      { property:"og:title", content:"PalletPlatform — Premium Wooden Pallet Manufacturer, Hyderabad" },
    ...
    canonical.rel = "canonical"; canonical.href = "https://www.palletplatform.in";
    ...
    schema.text = JSON.stringify({
      ...
      "name":"PalletPlatform","url":"https://www.palletplatform.in",
      "logo":"https://www.palletplatform.in/logo.png",
      ...
      "telephone":"+914040062841","email":"sales@palletplatform.in",
...
// ─── MAIN COMPONENT ───────────────────────────────────────────────────────────
export default function PalletPlatform() {
    ...
    try {
      const res = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `Quote Request from ${formData.name} — PalletPlatform`,
          from_name: "PalletPlatform Website",
          name:       formData.name,
  ...
  return (
    <div style={{ background:"#FFFFFF", minHeight:"100vh", overflowX:"hidden" }}>
      ...
      <div className={`pp-pre${preloaderDone ? " done" : ""}`}>
        <div className="pp-pre-logo">PALLET<em>PLATFORM</em></div>
      ...
      <nav className={`pp-nav${scrolled ? " scrolled" : ""}`}>
        <a href="#home" className="pp-logo">
          ...
          <div className="pp-logo-text">PALLET<em>PLATFORM</em></div>
        </a>
      ...
      <section className="pp-hero" id="home">
        ...
        <div className="pp-hero-content">
          <div className="pp-hero-left">
            ...
            <p className="pp-hero-sub">PalletPlatform manufactures premium wooden pallets for logistics, warehousing and export. ISPM-15 certified. Custom engineered. Pan-India and worldwide.</p>
      ...
      <section className="pp-section pp-why pp-reveal" id="why">
        ...
        <h2 className="pp-sh">THE <em>PALLETPLATFORM</em> DIFFERENCE</h2>
      ...
      <footer className="pp-footer">
        <div className="pp-fg">
          <div>
            <a href="#home" className="pp-logo">
              <div className="pp-logo-icon"><b/><b/><b/></div>
              <div className="pp-logo-text" style={{color:"#fff"}}>PALLET<em>PLATFORM</em></div>
            </a>
        ...
        <div className="pp-fbot">
          <span>© 2024 PalletPlatform. All rights reserved. Made in <span className="highlight">Hyderabad 🇮🇳</span></span>
