...
#pp-indiaMap path{fill:var(--wood-pale);stroke:#fff;stroke-width:1;transition:fill .25s;cursor:pointer;}
#pp-indiaMap path:hover{fill:var(--amber);}
...
const testimonialSlides = [
  [
    { initials:"RK", name:"Rajesh Kumar", company:"Export Manager · Hyderabad Pharma Ltd.", text:"PalletPro has been our go-to for two years. ISPM-15 pallets clear customs every time without issues. Delivery and quality are consistently outstanding." },
    { initials:"SA", name:"Sunita Agarwal", company:"Logistics Head · FastFreight India", text:"Switched to PalletPro and the difference was immediate. Better wood quality, tighter tolerances and 48-hour dispatch is a game changer." },
  ...
  [
    { initials:"AK", name:"Anil Krishnamurthy", company:"Director · Deccan Export House", text:"ISPM-15 pallets for our US exports — zero rejections in 18 months. PalletPro's documentation is thorough and the HT stamps are always compliant." },
    { initials:"NR", name:"Nisha Reddy", company:"Supply Chain · BioTech Pharma", text:"We needed 2,000 plywood pallets for our pharma dispatch within a week. PalletPro delivered on day 6, full QC report included. Impressive." },
...
// ─── INDIA MAP ───────────────────────────────────────────────────────────────
const states = [
  { name:"Jammu & Kashmir", info:"Northern-most region, supplied via Delhi hub", d:"M180,20 L220,15 L260,25 L270,50 L250,70 L220,80 L190,70 L170,50 Z" },
  { name:"Himachal Pradesh", info:"Mountain state, 3-5 day delivery", d:"M210,80 L250,70 L265,85 L255,105 L225,110 L205,100 Z" },
  { name:"Punjab", info:"Major agricultural hub, high pallet demand", d:"M170,75 L210,80 L205,100 L185,110 L160,100 L155,85 Z" },
  { name:"Haryana", info:"Industrial corridor, 48H dispatch", d:"M185,110 L225,110 L230,130 L210,145 L185,140 L175,125 Z" },
  { name:"Delhi", info:"★ Key Hub — 24H express dispatch", d:"M210,130 L230,130 L232,148 L210,150 L205,140 Z", special:true, fill:"#D4880A", opacity:"0.6" },
  { name:"Rajasthan", info:"Largest state, 3-4 day delivery", d:"M120,110 L175,100 L185,140 L175,200 L145,230 L100,220 L80,180 L90,140 Z" },
  { name:"Uttar Pradesh", info:"Largest population, huge logistics demand", d:"M210,150 L285,130 L320,155 L310,210 L270,230 L220,225 L185,210 L175,180 L185,160 Z" },
  { name:"Uttarakhand", info:"Hill state, routed via Delhi", d:"M230,100 L270,85 L295,100 L290,125 L255,130 L230,130 Z" },
  { name:"Bihar", info:"Growing industrial base", d:"M310,155 L360,145 L375,175 L365,205 L330,215 L310,210 Z" },
  { name:"Jharkhand", info:"Steel industry, heavy-duty pallet demand", d:"M330,215 L375,200 L390,225 L370,255 L340,255 L320,240 Z" },
  { name:"West Bengal", info:"Major port city access, export pallets", d:"M365,165 L400,160 L415,190 L405,230 L380,245 L360,225 L375,195 Z" },
  { name:"Sikkim", info:"Small state, 5-7 day delivery", d:"M380,145 L400,140 L405,160 L385,165 Z" },
  { name:"Assam", info:"Northeast gateway", d:"M400,155 L445,150 L460,170 L445,190 L415,195 L405,175 Z" },
  { name:"Meghalaya", info:"Northeast state", d:"M415,195 L450,192 L455,215 L430,220 L415,210 Z" },
  { name:"Nagaland", info:"Northeast state", d:"M455,160 L480,155 L485,178 L460,182 Z" },
  { name:"Manipur", info:"Northeast state", d:"M460,182 L485,178 L488,205 L462,208 Z" },
  { name:"Mizoram", info:"Northeast state", d:"M455,215 L480,210 L482,235 L456,238 Z" },
  { name:"Tripura", info:"Northeast state", d:"M435,222 L458,218 L460,240 L435,242 Z" },
  { name:"Madhya Pradesh", info:"Central India hub, 2-3 day delivery", d:"M145,225 L220,225 L270,230 L285,270 L265,305 L220,310 L170,300 L135,270 L130,245 Z" },
  { name:"Gujarat", info:"Largest port access, export specialist zone", d:"M60,200 L100,200 L130,230 L130,275 L100,295 L65,285 L45,255 L50,225 Z" },
  { name:"Maharashtra", info:"★ Key Hub — Mumbai, 48H dispatch", d:"M100,295 L165,300 L220,310 L225,355 L200,385 L165,390 L130,375 L95,345 L80,315 Z", special:true, fill:"#C4A882", opacity:"0.7" },
  { name:"Chhattisgarh", info:"Mineral rich, industrial pallets in demand", d:"M265,270 L320,265 L340,295 L325,340 L290,350 L265,330 L255,300 Z" },
  { name:"Odisha", info:"East coast, port city access", d:"M340,255 L390,250 L400,290 L380,330 L345,340 L325,315 L340,280 Z" },
  { name:"Telangana", info:"★ HOME BASE — 24H express dispatch", d:"M225,355 L265,345 L290,360 L285,400 L255,415 L225,405 L210,385 Z", special:true, fill:"#D4880A", opacity:"0.8" },
  { name:"Andhra Pradesh", info:"Coastal state, port export access", d:"M255,415 L295,400 L325,415 L320,460 L285,475 L255,460 L240,435 Z" },
  { name:"Karnataka", info:"Bangalore tech hub, high demand", d:"M165,390 L210,385 L225,405 L240,435 L225,470 L195,485 L160,470 L145,440 L150,410 Z", special:true, fill:"#C4A882", opacity:"0.7" },
  { name:"Goa", info:"Small state, tourist and export", d:"M130,445 L150,440 L155,460 L135,465 Z" },
  { name:"Kerala", info:"Southern coast, spice export pallets", d:"M170,470 L195,465 L200,505 L180,520 L160,510 L155,485 Z" },
  { name:"Tamil Nadu", info:"★ Key Hub — Chennai, 48H dispatch", d:"M225,465 L285,475 L290,515 L265,540 L240,545 L215,530 L205,500 L215,475 Z", special:true, fill:"#C4A882", opacity:"0.7" },
];

// ─── MAIN COMPONENT ───────────────────────────────────────────────────────────
export default function PalletPro() {
  ...
  const [hoveredState, setHoveredState] = useState({ name:"Hover any state", info:"We deliver to all 28 states and 8 UTs across India" });
  ...
  const [calcResult, setCalcResult] = useState({ lead:"7", breakdown:[
  ...
  return (
    <div style={{ background:"#FFFFFF", minHeight:"100vh", overflowX:"hidden" }}>
      ...
      <div className={`pp-pre${preloaderDone ? " done" : ""}`}>
        <div className="pp-pre-logo">PALLET<em>PRO</em></div>
      ...
      <nav className={`pp-nav${scrolled ? " scrolled" : ""}`}>
        <a href="#home" className="pp-logo">
          ...
          <div className="pp-logo-text">PALLET<em>PRO</em></div>
        </a>
      ...
      <section className="pp-hero" id="home">
        ...
        <div className="pp-hero-content">
          <div className="pp-hero-left">
            ...
            <p className="pp-hero-sub">PalletPro manufactures premium wooden pallets for logistics, warehousing and export. ISPM-15 certified. Custom engineered. Pan-India and worldwide.</p>
            ...
            <g>
              {states.map(s => (
                <path key={s.name} d={s.d}
                  ...
                  onMouseEnter={() => setHoveredState({ name: s.name, info: s.info })}
                  onMouseLeave={() => setHoveredState({ name:"Hover any state", info:"We deliver to all 28 states and 8 UTs across India" })}
                />
              ))}
            </g>
      ...
      <section className="pp-section pp-why pp-reveal" id="why">
        ...
        <h2 className="pp-sh">THE <em>PALLETPRO</em> DIFFERENCE</h2>
        ...
        <div className="pp-cgrid">
          <div className="pp-cinfo">
            {[
              ...
              ["✉️","Email","sales@palletpro.in","Response within 4 business hours"],
          ...
          <div className="pp-cform">
            ...
            <div className="pp-crow">
              <div className="pp-cg"><label>Pallet Type</label>
                <select value={formData.palletType} onChange={e => setFormData(f=>({...f,palletType:e.target.value}))}>
            ...
            <button className="pp-csub" onClick={playKnock}>Send Quote Request →</button>
          </div>
        </div>
      </section>
      ...
      <footer className="pp-footer">
        <div className="pp-fg">
          <div>
            <a href="#home" className="pp-logo">
              <div className="pp-logo-icon"><b/><b/><b/></div>
              <div className="pp-logo-text" style={{color:"#fff"}}>PALLET<em>PRO</em></div>
            </a>
        ...
        <div className="pp-fbot">
          <span>© 2024 PalletPro. All rights reserved. Made in <span className="highlight">Hyderabad 🇮🇳</span></span>
